...
from qsourcelogger.lib.plugin_common import gen_adif, get_points
from qsourcelogger.lib.version import __version__
from qsourcelogger.lib.ham_utility import distance
