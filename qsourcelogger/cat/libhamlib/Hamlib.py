...
if plat == 'linux-aarch64':
    from .linux_aarch64 import _Hamlib
elif plat == 'darwin-arm64':
    from .darwin_arm64 import _Hamlib
elif plat == 'win32-amd64':
    from .win32_amd64 import _Hamlib
else:
    raise Exception("Hamlib cython not available for " + plat)
...
RIG_MODEL_FT450D = _Hamlib.RIG_MODEL_FT450D
RIG_MODEL_FT650 = _Hamlib.RIG_MODEL_FT650
RIG_MODEL_FT990UNI = _Hamlib.RIG_MODEL_FT990UNI
RIG_MODEL_FT710 = _Hamlib.RIG_MODEL_FT710
...
RIG_MODEL_LAB599_TX500 = _Hamlib.RIG_MODEL_LAB599_TX500
RIG_MODEL_SDRUNO = _Hamlib.RIG_MODEL_SDRUNO
RIG_MODEL_QRPLABS = _Hamlib.RIG_MODEL_QRPLABS
...
RIG_MODEL_ICF8101 = _Hamlib.RIG_MODEL_ICF8101
RIG_MODEL_X6100 = _Hamlib.RIG_MODEL_X6100
RIG_MODEL_G90 = _Hamlib.RIG_MODEL_G90
RIG_MODEL_X5105 = _Hamlib.RIG_MODEL_X5105
...
RIG_MODEL_EK89X = _Hamlib.RIG_MODEL_EK89X
...
RIG_MODEL_BARRETT_4050 = _Hamlib.RIG_MODEL_BARRETT_4050
RIG_ELAD = _Hamlib.RIG_ELAD
RIG_BACKEND_ELAD = _Hamlib.RIG_BACKEND_ELAD
RIG_MODEL_ELAD_FDM_DUO = _Hamlib.RIG_MODEL_ELAD_FDM_DUO
RIG_CODAN = _Hamlib.RIG_CODAN
RIG_BACKEND_CODAN = _Hamlib.RIG_BACKEND_CODAN
RIG_MODEL_CODAN_ENVOY = _Hamlib.RIG_MODEL_CODAN_ENVOY
RIG_MODEL_CODAN_NGT = _Hamlib.RIG_MODEL_CODAN_NGT
RIG_GOMSPACE = _Hamlib.RIG_GOMSPACE
RIG_BACKEND_GOMSPACE = _Hamlib.RIG_BACKEND_GOMSPACE
RIG_MODEL_GS100 = _Hamlib.RIG_MODEL_GS100
BUILTINFUNC = _Hamlib.BUILTINFUNC
HAMLIB_SECRET_LENGTH = _Hamlib.HAMLIB_SECRET_LENGTH
...
RIG_EDEPRECATED = _Hamlib.RIG_EDEPRECATED
RIG_ESECURITY = _Hamlib.RIG_ESECURITY
RIG_EPOWER = _Hamlib.RIG_EPOWER
RIG_EEND = _Hamlib.RIG_EEND
...
HAMLIB_MAX_SPECTRUM_DATA = _Hamlib.HAMLIB_MAX_SPECTRUM_DATA
...
HAMLIB_MAX_SNAPSHOT_PACKET_SIZE = _Hamlib.HAMLIB_MAX_SNAPSHOT_PACKET_SIZE
...
RIG_AGC_LONG = _Hamlib.RIG_AGC_LONG
RIG_AGC_ON = _Hamlib.RIG_AGC_ON
RIG_AGC_NONE = _Hamlib.RIG_AGC_NONE
...
RIG_TARGETABLE_BAND = _Hamlib.RIG_TARGETABLE_BAND
...
RIG_BAND_160M = _Hamlib.RIG_BAND_160M
RIG_BAND_80M = _Hamlib.RIG_BAND_80M
RIG_BAND_60M = _Hamlib.RIG_BAND_60M
RIG_BAND_40M = _Hamlib.RIG_BAND_40M
RIG_BAND_30M = _Hamlib.RIG_BAND_30M
RIG_BAND_20M = _Hamlib.RIG_BAND_20M
RIG_BAND_17M = _Hamlib.RIG_BAND_17M
RIG_BAND_15M = _Hamlib.RIG_BAND_15M
RIG_BAND_12M = _Hamlib.RIG_BAND_12M
RIG_BAND_10M = _Hamlib.RIG_BAND_10M
RIG_BAND_6M = _Hamlib.RIG_BAND_6M
RIG_BAND_GEN = _Hamlib.RIG_BAND_GEN
RIG_BAND_MW = _Hamlib.RIG_BAND_MW
RIG_BAND_UNUSED = _Hamlib.RIG_BAND_UNUSED
RIG_BAND_AIR = _Hamlib.RIG_BAND_AIR
RIG_BAND_144MHZ = _Hamlib.RIG_BAND_144MHZ
RIG_BAND_430MHZ = _Hamlib.RIG_BAND_430MHZ
...
RIG_AGC_LAST = _Hamlib.RIG_AGC_LAST
...
RIG_LEVEL_BAND_SELECT = _Hamlib.RIG_LEVEL_BAND_SELECT
RIG_LEVEL_USB_AF = _Hamlib.RIG_LEVEL_USB_AF
RIG_LEVEL_AGC_TIME = _Hamlib.RIG_LEVEL_AGC_TIME
...
RIG_PARM_AFIF = _Hamlib.RIG_PARM_AFIF
...
RIG_FUNC_SEND_MORSE = _Hamlib.RIG_FUNC_SEND_MORSE
RIG_FUNC_SEND_VOICE_MEM = _Hamlib.RIG_FUNC_SEND_VOICE_MEM
RIG_FUNC_OVF_STATUS = _Hamlib.RIG_FUNC_OVF_STATUS
...
RIG_MODE_ISBUSB = _Hamlib.RIG_MODE_ISBUSB
RIG_MODE_ISBLSB = _Hamlib.RIG_MODE_ISBLSB
...
RIG_MODE_ALL = _Hamlib.RIG_MODE_ALL
...
HAMLIB_CHECK_RIG_CAPS = _Hamlib.HAMLIB_CHECK_RIG_CAPS
class rig_caps(object):
    ...
    async_data_supported = property(_Hamlib.rig_caps_async_data_supported_get, _Hamlib.rig_caps_async_data_supported_set)
    read_frame_direct = property(_Hamlib.rig_caps_read_frame_direct_get, _Hamlib.rig_caps_read_frame_direct_set)
    is_async_frame = property(_Hamlib.rig_caps_is_async_frame_get, _Hamlib.rig_caps_is_async_frame_set)
    process_async_frame = property(_Hamlib.rig_caps_process_async_frame_get, _Hamlib.rig_caps_process_async_frame_set)
    hamlib_check_rig_caps = property(_Hamlib.rig_caps_hamlib_check_rig_caps_get, _Hamlib.rig_caps_hamlib_check_rig_caps_set)
    get_conf2 = property(_Hamlib.rig_caps_get_conf2_get, _Hamlib.rig_caps_get_conf2_set)
    password = property(_Hamlib.rig_caps_password_get, _Hamlib.rig_caps_password_set)
    set_lock_mode = property(_Hamlib.rig_caps_set_lock_mode_get, _Hamlib.rig_caps_set_lock_mode_set)
    get_lock_mode = property(_Hamlib.rig_caps_get_lock_mode_get, _Hamlib.rig_caps_get_lock_mode_set)
...
RIG_FUNCTION_SEND_VOICE_MEM = _Hamlib.RIG_FUNCTION_SEND_VOICE_MEM
...
RIG_FUNCTION_READ_FRAME_DIRECT = _Hamlib.RIG_FUNCTION_READ_FRAME_DIRECT
RIG_FUNCTION_IS_ASYNC_FRAME = _Hamlib.RIG_FUNCTION_IS_ASYNC_FRAME
RIG_FUNCTION_PROCESS_ASYNC_FRAME = _Hamlib.RIG_FUNCTION_PROCESS_ASYNC_FRAME
RIG_FUNCTION_GET_CONF2 = _Hamlib.RIG_FUNCTION_GET_CONF2
...
class hamlib_port_t(object):
    ...
    asyncio = property(_Hamlib.hamlib_port_t_asyncio_get, _Hamlib.hamlib_port_t_asyncio_set)
    fd_sync_write = property(_Hamlib.hamlib_port_t_fd_sync_write_get, _Hamlib.hamlib_port_t_fd_sync_write_set)
    fd_sync_read = property(_Hamlib.hamlib_port_t_fd_sync_read_get, _Hamlib.hamlib_port_t_fd_sync_read_set)
    fd_sync_error_write = property(_Hamlib.hamlib_port_t_fd_sync_error_write_get, _Hamlib.hamlib_port_t_fd_sync_error_write_set)
    fd_sync_error_read = property(_Hamlib.hamlib_port_t_fd_sync_error_read_get, _Hamlib.hamlib_port_t_fd_sync_error_read_set)
...
class hamlib_port_t_deprecated(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    type = property(_Hamlib.hamlib_port_t_deprecated_type_get)
    fd = property(_Hamlib.hamlib_port_t_deprecated_fd_get, _Hamlib.hamlib_port_t_deprecated_fd_set)
    handle = property(_Hamlib.hamlib_port_t_deprecated_handle_get, _Hamlib.hamlib_port_t_deprecated_handle_set)
    write_delay = property(_Hamlib.hamlib_port_t_deprecated_write_delay_get, _Hamlib.hamlib_port_t_deprecated_write_delay_set)
    post_write_delay = property(_Hamlib.hamlib_port_t_deprecated_post_write_delay_get, _Hamlib.hamlib_port_t_deprecated_post_write_delay_set)
    post_write_date = property(_Hamlib.hamlib_port_t_deprecated_post_write_date_get)
    timeout = property(_Hamlib.hamlib_port_t_deprecated_timeout_get, _Hamlib.hamlib_port_t_deprecated_timeout_set)
    retry = property(_Hamlib.hamlib_port_t_deprecated_retry_get, _Hamlib.hamlib_port_t_deprecated_retry_set)
    flushx = property(_Hamlib.hamlib_port_t_deprecated_flushx_get, _Hamlib.hamlib_port_t_deprecated_flushx_set)
    pathname = property(_Hamlib.hamlib_port_t_deprecated_pathname_get, _Hamlib.hamlib_port_t_deprecated_pathname_set)
    parm = property(_Hamlib.hamlib_port_t_deprecated_parm_get)
    client_port = property(_Hamlib.hamlib_port_t_deprecated_client_port_get, _Hamlib.hamlib_port_t_deprecated_client_port_set)
    rig = property(_Hamlib.hamlib_port_t_deprecated_rig_get, _Hamlib.hamlib_port_t_deprecated_rig_set)

    def __init__(self):
        _Hamlib.hamlib_port_t_deprecated_swiginit(self, _Hamlib.new_hamlib_port_t_deprecated())
    __swig_destroy__ = _Hamlib.delete_hamlib_port_t_deprecated

# Register hamlib_port_t_deprecated in _Hamlib:
_Hamlib.hamlib_port_t_deprecated_swigregister(hamlib_port_t_deprecated)
class hamlib_port_deprecated_parm(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    serial = property(_Hamlib.hamlib_port_deprecated_parm_serial_get)
    parallel = property(_Hamlib.hamlib_port_deprecated_parm_parallel_get)
    cm108 = property(_Hamlib.hamlib_port_deprecated_parm_cm108_get)
    usb = property(_Hamlib.hamlib_port_deprecated_parm_usb_get)
    gpio = property(_Hamlib.hamlib_port_deprecated_parm_gpio_get)

    def __init__(self):
        _Hamlib.hamlib_port_deprecated_parm_swiginit(self, _Hamlib.new_hamlib_port_deprecated_parm())
    __swig_destroy__ = _Hamlib.delete_hamlib_port_deprecated_parm

# Register hamlib_port_deprecated_parm in _Hamlib:
_Hamlib.hamlib_port_deprecated_parm_swigregister(hamlib_port_deprecated_parm)
class hamlib_port_deprecated_parm_gpio(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    on_value = property(_Hamlib.hamlib_port_deprecated_parm_gpio_on_value_get, _Hamlib.hamlib_port_deprecated_parm_gpio_on_value_set)
    value = property(_Hamlib.hamlib_port_deprecated_parm_gpio_value_get, _Hamlib.hamlib_port_deprecated_parm_gpio_value_set)

    def __init__(self):
        _Hamlib.hamlib_port_deprecated_parm_gpio_swiginit(self, _Hamlib.new_hamlib_port_deprecated_parm_gpio())
    __swig_destroy__ = _Hamlib.delete_hamlib_port_deprecated_parm_gpio

# Register hamlib_port_deprecated_parm_gpio in _Hamlib:
_Hamlib.hamlib_port_deprecated_parm_gpio_swigregister(hamlib_port_deprecated_parm_gpio)
class hamlib_port_deprecated_parm_usb(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    vid = property(_Hamlib.hamlib_port_deprecated_parm_usb_vid_get, _Hamlib.hamlib_port_deprecated_parm_usb_vid_set)
    pid = property(_Hamlib.hamlib_port_deprecated_parm_usb_pid_get, _Hamlib.hamlib_port_deprecated_parm_usb_pid_set)
    conf = property(_Hamlib.hamlib_port_deprecated_parm_usb_conf_get, _Hamlib.hamlib_port_deprecated_parm_usb_conf_set)
    iface = property(_Hamlib.hamlib_port_deprecated_parm_usb_iface_get, _Hamlib.hamlib_port_deprecated_parm_usb_iface_set)
    alt = property(_Hamlib.hamlib_port_deprecated_parm_usb_alt_get, _Hamlib.hamlib_port_deprecated_parm_usb_alt_set)
    vendor_name = property(_Hamlib.hamlib_port_deprecated_parm_usb_vendor_name_get, _Hamlib.hamlib_port_deprecated_parm_usb_vendor_name_set)
    product = property(_Hamlib.hamlib_port_deprecated_parm_usb_product_get, _Hamlib.hamlib_port_deprecated_parm_usb_product_set)

    def __init__(self):
        _Hamlib.hamlib_port_deprecated_parm_usb_swiginit(self, _Hamlib.new_hamlib_port_deprecated_parm_usb())
    __swig_destroy__ = _Hamlib.delete_hamlib_port_deprecated_parm_usb

# Register hamlib_port_deprecated_parm_usb in _Hamlib:
_Hamlib.hamlib_port_deprecated_parm_usb_swigregister(hamlib_port_deprecated_parm_usb)
class hamlib_port_deprecated_parm_cm108(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ptt_bitnum = property(_Hamlib.hamlib_port_deprecated_parm_cm108_ptt_bitnum_get, _Hamlib.hamlib_port_deprecated_parm_cm108_ptt_bitnum_set)

    def __init__(self):
        _Hamlib.hamlib_port_deprecated_parm_cm108_swiginit(self, _Hamlib.new_hamlib_port_deprecated_parm_cm108())
    __swig_destroy__ = _Hamlib.delete_hamlib_port_deprecated_parm_cm108

# Register hamlib_port_deprecated_parm_cm108 in _Hamlib:
_Hamlib.hamlib_port_deprecated_parm_cm108_swigregister(hamlib_port_deprecated_parm_cm108)
class hamlib_port_deprecated_parm_parallel(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    pin = property(_Hamlib.hamlib_port_deprecated_parm_parallel_pin_get, _Hamlib.hamlib_port_deprecated_parm_parallel_pin_set)

    def __init__(self):
        _Hamlib.hamlib_port_deprecated_parm_parallel_swiginit(self, _Hamlib.new_hamlib_port_deprecated_parm_parallel())
    __swig_destroy__ = _Hamlib.delete_hamlib_port_deprecated_parm_parallel

# Register hamlib_port_deprecated_parm_parallel in _Hamlib:
_Hamlib.hamlib_port_deprecated_parm_parallel_swigregister(hamlib_port_deprecated_parm_parallel)
class hamlib_port_deprecated_parm_serial(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    rate = property(_Hamlib.hamlib_port_deprecated_parm_serial_rate_get, _Hamlib.hamlib_port_deprecated_parm_serial_rate_set)
    data_bits = property(_Hamlib.hamlib_port_deprecated_parm_serial_data_bits_get, _Hamlib.hamlib_port_deprecated_parm_serial_data_bits_set)
    stop_bits = property(_Hamlib.hamlib_port_deprecated_parm_serial_stop_bits_get, _Hamlib.hamlib_port_deprecated_parm_serial_stop_bits_set)
    parity = property(_Hamlib.hamlib_port_deprecated_parm_serial_parity_get, _Hamlib.hamlib_port_deprecated_parm_serial_parity_set)
    handshake = property(_Hamlib.hamlib_port_deprecated_parm_serial_handshake_get, _Hamlib.hamlib_port_deprecated_parm_serial_handshake_set)
    rts_state = property(_Hamlib.hamlib_port_deprecated_parm_serial_rts_state_get, _Hamlib.hamlib_port_deprecated_parm_serial_rts_state_set)
    dtr_state = property(_Hamlib.hamlib_port_deprecated_parm_serial_dtr_state_get, _Hamlib.hamlib_port_deprecated_parm_serial_dtr_state_set)

    def __init__(self):
        _Hamlib.hamlib_port_deprecated_parm_serial_swiginit(self, _Hamlib.new_hamlib_port_deprecated_parm_serial())
    __swig_destroy__ = _Hamlib.delete_hamlib_port_deprecated_parm_serial

# Register hamlib_port_deprecated_parm_serial in _Hamlib:
_Hamlib.hamlib_port_deprecated_parm_serial_swigregister(hamlib_port_deprecated_parm_serial)
class hamlib_port_deprecated_post_write_date(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    tv_sec = property(_Hamlib.hamlib_port_deprecated_post_write_date_tv_sec_get, _Hamlib.hamlib_port_deprecated_post_write_date_tv_sec_set)
    tv_usec = property(_Hamlib.hamlib_port_deprecated_post_write_date_tv_usec_get, _Hamlib.hamlib_port_deprecated_post_write_date_tv_usec_set)

    def __init__(self):
        _Hamlib.hamlib_port_deprecated_post_write_date_swiginit(self, _Hamlib.new_hamlib_port_deprecated_post_write_date())
    __swig_destroy__ = _Hamlib.delete_hamlib_port_deprecated_post_write_date

# Register hamlib_port_deprecated_post_write_date in _Hamlib:
_Hamlib.hamlib_port_deprecated_post_write_date_swigregister(hamlib_port_deprecated_post_write_date)
class hamlib_port_deprecated_type(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    rig = property(_Hamlib.hamlib_port_deprecated_type_rig_get, _Hamlib.hamlib_port_deprecated_type_rig_set)
    ptt = property(_Hamlib.hamlib_port_deprecated_type_ptt_get, _Hamlib.hamlib_port_deprecated_type_ptt_set)
    dcd = property(_Hamlib.hamlib_port_deprecated_type_dcd_get, _Hamlib.hamlib_port_deprecated_type_dcd_set)

    def __init__(self):
        _Hamlib.hamlib_port_deprecated_type_swiginit(self, _Hamlib.new_hamlib_port_deprecated_type())
    __swig_destroy__ = _Hamlib.delete_hamlib_port_deprecated_type

# Register hamlib_port_deprecated_type in _Hamlib:
_Hamlib.hamlib_port_deprecated_type_swigregister(hamlib_port_deprecated_type)
...
class rig_state(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    rigport_deprecated = property(_Hamlib.rig_state_rigport_deprecated_get, _Hamlib.rig_state_rigport_deprecated_set)
    pttport_deprecated = property(_Hamlib.rig_state_pttport_deprecated_get, _Hamlib.rig_state_pttport_deprecated_set)
    dcdport_deprecated = property(_Hamlib.rig_state_dcdport_deprecated_get, _Hamlib.rig_state_dcdport_deprecated_set)
    ...
    transaction_active = property(_Hamlib.rig_state_transaction_active_get, _Hamlib.rig_state_transaction_active_set)
    ...
    async_data_enabled = property(_Hamlib.rig_state_async_data_enabled_get, _Hamlib.rig_state_async_data_enabled_set)
    ...
    snapshot_packet_sequence_number = property(_Hamlib.rig_state_snapshot_packet_sequence_number_get, _Hamlib.rig_state_snapshot_packet_sequence_number_set)
    multicast_publisher_run = property(_Hamlib.rig_state_multicast_publisher_run_get, _Hamlib.rig_state_multicast_publisher_run_set)
    multicast_publisher_priv_data = property(_Hamlib.rig_state_multicast_publisher_priv_data_get, _Hamlib.rig_state_multicast_publisher_priv_data_set)
    async_data_handler_thread_run = property(_Hamlib.rig_state_async_data_handler_thread_run_get, _Hamlib.rig_state_async_data_handler_thread_run_set)
    async_data_handler_priv_data = property(_Hamlib.rig_state_async_data_handler_priv_data_get, _Hamlib.rig_state_async_data_handler_priv_data_set)
    poll_routine_thread_run = property(_Hamlib.rig_state_poll_routine_thread_run_get, _Hamlib.rig_state_poll_routine_thread_run_set)
    poll_routine_priv_data = property(_Hamlib.rig_state_poll_routine_priv_data_get, _Hamlib.rig_state_poll_routine_priv_data_set)
    mutex_set_transaction = property(_Hamlib.rig_state_mutex_set_transaction_get, _Hamlib.rig_state_mutex_set_transaction_set)
    ...
    use_cached_freq = property(_Hamlib.rig_state_use_cached_freq_get, _Hamlib.rig_state_use_cached_freq_set)
    use_cached_mode = property(_Hamlib.rig_state_use_cached_mode_get, _Hamlib.rig_state_use_cached_mode_set)
    use_cached_ptt = property(_Hamlib.rig_state_use_cached_ptt_get, _Hamlib.rig_state_use_cached_ptt_set)
    depth = property(_Hamlib.rig_state_depth_get, _Hamlib.rig_state_depth_set)
    lock_mode = property(_Hamlib.rig_state_lock_mode_get, _Hamlib.rig_state_lock_mode_set)
    powerstat = property(_Hamlib.rig_state_powerstat_get, _Hamlib.rig_state_powerstat_set)
...
def rig_get_conf2(rig, token, val, val_len):
    return _Hamlib.rig_get_conf2(rig, token, val, val_len)
...
def rigerror2(errnum):
    return _Hamlib.rigerror2(errnum)

def rig_setting2idx(s):
    return _Hamlib.rig_setting2idx(s)
HAMLIB_SETTINGS_FILE = _Hamlib.HAMLIB_SETTINGS_FILE
...
def add2debugmsgsave(s):
    return _Hamlib.add2debugmsgsave(s)
...
def rig_levelagcstr(agcString):
    return _Hamlib.rig_levelagcstr(agcString)

def rig_levelagcvalue(agcValue):
    return _Hamlib.rig_levelagcvalue(agcValue)

def rig_valueagclevel(agcLevel):
    return _Hamlib.rig_valueagclevel(agcLevel)
...
def rig_get_cache_freq(rig, vfo, freq, cache_ms_freq):
    return _Hamlib.rig_get_cache_freq(rig, vfo, freq, cache_ms_freq)
...
def rig_password(rig, key1):
    return _Hamlib.rig_password(rig, key1)

def rig_password_generate_secret(_pass, result):
    return _Hamlib.rig_password_generate_secret(_pass, result)

def rig_send_raw(rig, send, send_len, reply, reply_len, term):
    return _Hamlib.rig_send_raw(rig, send, send_len, reply, reply_len, term)
...
def rig_make_md5(_pass):
    return _Hamlib.rig_make_md5(_pass)

def rig_set_lock_mode(rig, lock):
    return _Hamlib.rig_set_lock_mode(rig, lock)

def rig_get_lock_mode(rig, lock):
    return _Hamlib.rig_get_lock_mode(rig, lock)

def rig_is_model(rig, model):
    return _Hamlib.rig_is_model(rig, model)
...
ROT_MODEL_YRC1 = _Hamlib.ROT_MODEL_YRC1
...
ROT_MODEL_GS23_AZ = _Hamlib.ROT_MODEL_GS23_AZ
ROT_ARRAYSOLUTIONS = _Hamlib.ROT_ARRAYSOLUTIONS
ROT_MODEL_ARRAYSOLUTIONS_SAL_12_20_30 = _Hamlib.ROT_MODEL_ARRAYSOLUTIONS_SAL_12_20_30
...
ROT_MODEL_PROSISTEL_D_EL_CBOXAZ = _Hamlib.ROT_MODEL_PROSISTEL_D_EL_CBOXAZ
...
ROT_GRBLTRK = _Hamlib.ROT_GRBLTRK
ROT_BACKEND_GRBLTRK = _Hamlib.ROT_BACKEND_GRBLTRK
ROT_MODEL_GRBLTRK_SER = _Hamlib.ROT_MODEL_GRBLTRK_SER
ROT_MODEL_GRBLTRK_NET = _Hamlib.ROT_MODEL_GRBLTRK_NET
...
class rot_caps(object):
    ...
    get_conf2 = property(_Hamlib.rot_caps_get_conf2_get, _Hamlib.rot_caps_get_conf2_set)
...
class rot_state(object):
    ...
    rotport_deprecated = property(_Hamlib.rot_state_rotport_deprecated_get, _Hamlib.rot_state_rotport_deprecated_set)
    rotport2_deprecated = property(_Hamlib.rot_state_rotport2_deprecated_get, _Hamlib.rot_state_rotport2_deprecated_set)
...
def rot_get_conf2(rot, token, val, val_len):
    return _Hamlib.rot_get_conf2(rot, token, val, val_len)
...
class Rig(object):
    ...
    def set_vfo_opt(self, _int):
        return _Hamlib.Rig_set_vfo_opt(self, _int)
